...
INSERT INTO `attachment` (`documento_id`,`track_id`,`user_id`,`fecha`) VALUES 
 (1,1,11,'2009-07-09 14:27:56'),
 (2,1,11,'2009-07-09 23:44:47'),
 (3,1,11,'2009-07-10 00:29:14'),
 (4,2,11,'2009-07-10 13:03:53'),
 (5,2,11,'2009-07-10 13:10:08'),
 (6,5,13,'2009-07-10 13:46:28'),
 (7,3,11,'2009-07-10 13:50:29'),
 (8,3,13,'2009-07-10 13:55:30');
...
INSERT INTO `documentos` (`id_documento`,`titulo`,`descripcion`,`docPath`,`version`,`tipo`) VALUES 
 (1,'Cantos','','/files/cantos.txt',1,NULL),
 (2,'Imagen','','/files/img.gif',1,NULL),
 (3,'','','/files/certificate.pdf',1,NULL),
 (4,'','','/files/Constancia_Cuil (Yo).pdf',1,NULL),
 (5,'','','/files/Constancias Inscripcion UNPSJB.JPG',1,NULL),
 (6,'','','/files/Propuesta de Solución - Suite de Colaboración (2) (25-07-2008).pdf',1,NULL),
 (7,'','','/files/img.gif',1,NULL),
 (8,'','','/files/consulta.sql',1,NULL);
...
INSERT INTO `sticky_notes` (`sticky_note_id`,`titulo`,`contenido`,`track_id`,`pegado`) VALUES 
 (1,'Título','Contenido',1,0),
 (5,'Título','Contenido',3,0),
 (8,'Pepe','Pepe 1',NULL,0),
 (9,'Pepe','Pepe1',NULL,0);
...
INSERT INTO `tracks` (`track_id`,`descripcion`,`observaciones`,`fecha_creacion`,`fecha_estimada_realizacion`,`deadline`,`fecha_realizacion`,`estado_id`,`user_id_owner`,`titulo`,`importancia_id`,`prioridad_id`,`orden`,`OBJ_VERSION`) VALUES 
 (1,'Este es el primer track','','2009-06-02 19:11:29',NULL,NULL,NULL,1,11,'Primer track',1,1,1,'0000-00-00 00:00:00'),
 (2,'Hola','','2009-06-02 20:20:50',NULL,NULL,NULL,1,11,'Hola',1,1,2,'0000-00-00 00:00:00'),
 (3,'Este es otro track','','2009-06-03 18:11:49','2009-07-15',NULL,NULL,1,11,'Track 1',1,1,3,'0000-00-00 00:00:00'),
...
INSERT INTO `website_users` (`user_id`,`login_name`,`login_password`,`nivel_visibilidad`,`nombre`,`apellido`,`email`,`nro_legajo`,`nro_comprador`,`OBJ_VERSION`,`fecha_nacimiento`) VALUES 
 ...
 (13,'juanperez','BqfWmg9HKe4bWol4/ATXU4jBNEg=',NULL,'Juan Manuel','Perez','jmcthemaster@hotmail.com',NULL,NULL,NULL,'1985-02-06 00:00:00'),
 (14,'cristian','h7Q0NShFObL39OTcq154JRwkMiY=',NULL,'Cristian','Pacheco',NULL,NULL,NULL,NULL,'1983-11-08 00:00:00');
