...
) ENGINE=InnoDB AUTO_INCREMENT=54802 DEFAULT CHARSET=latin1 COMMENT='Atributos asociados a la entidad; InnoDB free: 6144 kB; (`at';
...
) ENGINE=InnoDB AUTO_INCREMENT=7328 DEFAULT CHARSET=latin1;
...
CREATE TABLE `menu` (
  ...
  PRIMARY KEY  (`menu_id`),
  KEY `grupo_IDX` (`grupo`)
) ENGINE=InnoDB AUTO_INCREMENT=10307031 DEFAULT CHARSET=latin1;
