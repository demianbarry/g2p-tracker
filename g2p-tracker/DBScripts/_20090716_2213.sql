...
CREATE TABLE  `g2p_tracker`.`acciones_apps` (
  ...
  CONSTRAINT `fk_acciones_apps_circuitos_estados` FOREIGN KEY (`circuito_id`) REFERENCES `circuitos_estados` (`circuito_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `g2p_tracker`.`acciones_apps` VALUES  (1,'Completar','Completar el track hasta dejarlo listo para poder iniciarlo',NULL,1,'V',NULL,NULL),
 ...
 (8,'A Prueba 1.0','Accion de Prueba 1.0',NULL,19,'\0',NULL,NULL),
 (9,'A Prueba 1.1','Accion de Prueba 1.1',NULL,19,'\0',NULL,NULL),
 (10,'Prueba 2.0','Accion de Prueba 2.0',NULL,20,'\0',NULL,NULL),
 (11,'Prueba 2.1','Accion de Prueba 2.1',NULL,20,'\0',NULL,NULL),
 (12,'Prueba 4.0','Accion de prueba 4.0',NULL,21,'\0',NULL,NULL),
 (13,'Prueba 5.0','Accion de prueba 5.0',NULL,23,'\0',NULL,NULL),
 (14,'Prueba 6.0','Accion de prueba 6.0',NULL,24,'\0',NULL,NULL);
UNLOCK TABLES;
...
INSERT INTO `g2p_tracker`.`attachment` VALUES  (1,1,11,'2009-07-13 20:57:47'),
...
INSERT INTO `g2p_tracker`.`circuitos_estados` VALUES  (1,'Tracks','Circuito Administrativo para los tracks','Por ahora es el único circuito',NULL),
 (19,'Prueba','','',NULL),
 (20,'Prueba 2',NULL,NULL,NULL),
 (21,'Prueba 4',NULL,NULL,NULL),
 (22,'Prueba 3',NULL,NULL,NULL),
 (23,'Prueba 5','Estado de prueba 5','',NULL),
 (24,'Prueba 6','Circuito de Prueba 6','',NULL),
 (25,'Prueba 8',NULL,NULL,NULL);
UNLOCK TABLES;
...
INSERT INTO `g2p_tracker`.`documentos` VALUES  (1,'','','/files/carga.txt',1,NULL),
...
CREATE TABLE  `g2p_tracker`.`estados` (
  ...
  CONSTRAINT `fk_estados_circuitos_estados` FOREIGN KEY (`circuito_id`) REFERENCES `circuitos_estados` (`circuito_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `g2p_tracker`.`estados` VALUES  (1,'Generado','Track recién creado',NULL,1,NULL,NULL),
 ...
 (13,'Prueba 1.0','Estado de Prueba 1.0',NULL,19,NULL,NULL),
 (14,'Prueba 1.1','Estado de Prueba 1.1',NULL,19,NULL,NULL),
 (15,'Prueba 1.2','Estado de Prueba 1.2',NULL,19,NULL,NULL),
 (16,'Prueba 2.0','Estado de prueba 2.0',NULL,20,NULL,NULL),
 (17,'Prueba 2.1','Estado de prueba 2.1',NULL,20,NULL,NULL),
 (18,'Prueba 2.2','Estado de prueba 2.2',NULL,20,NULL,NULL),
 (19,'Prueba 5.0','Estado de prueba 5.0',NULL,23,NULL,NULL),
 (20,'Prueba 5.1','Estado de prueba 5.1',NULL,23,NULL,NULL),
 (21,'Prueba 5.2','Estado de prueba 5.2',NULL,23,NULL,NULL),
 (22,'Prueba 6.0','Estado de prueba 6.0',NULL,24,NULL,NULL);
INSERT INTO `g2p_tracker`.`estados` VALUES  (23,'Prueba 6.1','Estado de prueba 6.1',NULL,24,NULL,NULL);
UNLOCK TABLES;
...
INSERT INTO `g2p_tracker`.`importancia` VALUES  (1,NULL,'Mucha',5);
UNLOCK TABLES;
...
INSERT INTO `g2p_tracker`.`prioridades` VALUES  (1,'','alta',5);
UNLOCK TABLES;
...
INSERT INTO `g2p_tracker`.`sticky_notes` VALUES  (1,'Sticky','Hacer esto...',3,0),
...
INSERT INTO `g2p_tracker`.`tracks` VALUES  (1,'Este es el primer track','','2009-06-02 19:11:29',NULL,NULL,NULL,1,11,'Primer track',1,1,1,1,'0000-00-00 00:00:00'),
...
CREATE TABLE  `g2p_tracker`.`transicion_estados` (
  `transicion_id` int(11) NOT NULL auto_increment,
  ...
  KEY `fk_transicion_estados_circuitos` (`circuito_id`),
  ...
  CONSTRAINT `fk_transicion_estados_circuitos` FOREIGN KEY (`circuito_id`) REFERENCES `circuitos_estados` (`circuito_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `g2p_tracker`.`transicion_estados` VALUES  (1,1,1,2,'Aceptar',NULL,NULL,NULL,NULL,1),
 (2,2,2,3,'Start',NULL,NULL,NULL,NULL,1),
 (3,3,3,4,'Stop',NULL,NULL,NULL,NULL,1),
 (4,22,14,23,'Cambiar',NULL,NULL,NULL,NULL,24),
 (5,13,8,14,'Cambiar',NULL,NULL,NULL,NULL,19),
 (6,14,9,15,'Cambio 2',NULL,NULL,NULL,NULL,19),
 (7,4,4,5,'Accept',NULL,NULL,NULL,NULL,1),
 (8,4,5,6,'Reject',NULL,NULL,NULL,NULL,1),
 (9,6,6,2,'Review',NULL,NULL,NULL,NULL,1);
UNLOCK TABLES;
