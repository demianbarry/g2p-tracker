...
INSERT INTO `attachment` (`documento_id`,`track_id`,`user_id`,`fecha`) VALUES 
 ...
 (16,1,11,'2009-07-16 23:40:45'),
 (17,1,11,'2009-07-17 13:16:55');
...
INSERT INTO `documentos` (`id_documento`,`titulo`,`descripcion`,`docPath`,`version`,`tipo`) VALUES 
 ...
 (16,'Otroooo','Este es un documento','/files/truncate tango.sql',1,NULL),
 (17,'a ver','Este archivo se va a subir','/files/consulta.sql',1,NULL);
...
INSERT INTO `menu` (`menu_id`,`nombre`,`descripcion`,`url`,`grupo`) VALUES 
 ...
 (7,'Menu','Administración de menues y accesos','BaseMenuPage.zul','HomePage.zul'),
 (8,'Menu','Administración de menues','AbmMenu.zul','BaseMenuPage.zul'),
 (9,'Accesos','Administración de accesos','AbmAccesoMenu.zul','BaseMenuPage.zul');
...
INSERT INTO `sticky_notes` (`sticky_note_id`,`titulo`,`contenido`,`track_id`,`leido`) VALUES 
 ...
 (5,'Título','Contenido',1,1),
 (6,'Dibujar modelo','Se debe realizar el modelo para la BD.',7,0),
 (7,'Ver estp','A ver si funciona',4,0),
 (8,'Y ahora???','Esta vez???',4,0),
 (9,'Otro tracxk','11111',2,0);
...
CREATE TABLE `transicion_estados` (
  ...
  `circuito_id` int(10) unsigned default NULL,
